        ...
        <form action="{{ route('dienstplan.update.user', $user->id) }}" id="DienstplanUserEditUserForm" method="post"
            ...
            <span class="form-label">                
                <input name="username" value="{{ old('username', $user->username) }}" maxlength="255" type="text"
                    id="DienstplanUserUsername" required="required" class="{{ old('username', $user->username) == null ?: 'hascontent'}}">
            ...
            <span class="form-label">
                <input name="first_name" value="{{  old('first_name',$user->first_name) }}" maxlength="250" type="text" id="DienstplanUserVorname"
                    required="required"  class="{{ old('first_name', $user->first_name) == null ?: 'hascontent'}}">
            ...
            <span class="form-label">
                <input name="last_name" value="{{ old('last_name',$user->last_name) }}" maxlength="250" type="text"
                    id="DienstplanUserNachname" required="required"  class="{{ old('last_name', $user->last_name) == null ?: 'hascontent'}}">
            ...
            <span class="form-label">
                <input name="email" value="{{ old('email',$user->email) }}" maxlength="255" type="email" id="DienstplanUserEmail"
                    required="required" class="{{ old('email', $user->email) == null ?: 'hascontent'}}">
            ...
            <span class="form-label">
                ...
                class="{{ old('plain',$user->plain ?? '') == null ?: 'hascontent'}}">
            ...
            <span class="form-label">
                <input name="hausnummer" value="{{ old('hausnummer',$user->strasse ) }}" maxlength="5" type="text" id="DienstplanUserHausnummer"
            ...
            <span class="form-label">
                ...
                class="{{ old('plz',$user->plz ?? '') == null ?: 'hascontent'}}">
            ...
            <span class="form-label">
                ...
                class="{{ old('ort',$user->ort ?? '') == null ?: 'hascontent'}}">
            ...
            <span class="form-label">
                ...
                class="{{ old('mobile',$user->mobile ?? '') == null ?: 'hascontent'}}">
