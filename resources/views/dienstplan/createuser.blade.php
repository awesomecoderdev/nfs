...
.ex-checkbox input:focus~label, .ex-checkbox input.hascontent~label {
    ...
    <div class="settings settingsss">
        <form action="{{ route('dienstplan.user.create') }}" id="DienstplanUserEditUserForm" method="post"
            ...
            <span class="form-label">
                <input name="first_name" value="{{ old('first_name') }}" maxlength="250" type="text" id="DienstplanUserVorname"
                    required="required">
            ...
            <span class="form-label">
                <input name="email" value="{{ old('email') }}" maxlength="255" type="email" id="DienstplanUserEmail"
                    required="required">
            ...
            <span class="form-label">
                <input name="plain" value="{{ old('plain') }}" maxlength="255" type="text" id="DienstplanUserPlain">
            <label for="DienstplanUserPlain">Passwort</label>   
            </span>
            <span class="form-label">
                <input name="strasse" value="{{ old('strasse') }}" maxlength="250" type="text" id="DienstplanUserStrasse">
                <label for="DienstplanUserStrasse">Straße</label>    
            </span>
            <span class="form-label">
                <input name="hausnummer" value="{{ old('hausnummer') }}" maxlength="5" type="text" id="DienstplanUserHausnummer">
            ...
            <span class="form-label">
                <input name="ort" value="{{ old('ort') }}" maxlength="250" type="text" id="DienstplanUserOrt">
                <label for="DienstplanUserOrt">Ort</label>
            </span>
            <span class="form-label">
                <input name="telephone" value="{{ old('telephone') }}" maxlength="50" type="text" id="DienstplanUserTelefon">
            ...
            <span class="form-label">
                <input name="mobile" value="{{ old('mobile') }}" maxlength="50" type="text" id="DienstplanUserMobil">
                <label for="DienstplanUserMobil">Mobil</label>
            </span>
            <div class="ex-checkbox">
                <input type="checkbox" name="dienstplan_access" @checked(old('dienstplan_access', false))
            ...
            <div class="ex-checkbox">
                ...
                <input type="checkbox" name="nachsorge_access" value="1" id="DienstplanUserNachsorgeAccess" @checked(old('nachsorge_access', false)) >
            ...
            <div class="ex-checkbox">
                ...
                <input type="checkbox" name="contact_maintainer" value="1"
                     @checked(old('contact_maintainer', false))
            ...
            <div class="ex-checkbox">
                ...
                <input type="checkbox" name="hour_overview_access" value="1"
                    @checked(old('hour_overview_access', false))
