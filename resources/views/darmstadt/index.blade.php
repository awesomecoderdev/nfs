<x-app-layout>
    @section('head')
        <title> Willkommen bei der Notfallseelsorge Darmstadt und Umgebung | {{ __(config('app.name')) }}</title>
    @endsection
    ...
    <div class="column-8 bgwhite">
        <h3> Willkommen bei der Notfallseelsorge Darmstadt und Umgebung</h3>
